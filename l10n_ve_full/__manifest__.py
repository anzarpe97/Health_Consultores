# -*- coding: utf-8 -*-
{
    ...
    'company': 'Contables Boyer Leon & Asociados, S.A',
    'maintainer': 'Devs by Contables',
    'website': 'https://www.contablesag.com/',
    'category': 'Localization',
    'depends': ['base', 'base_vat', 'base_address_extended','l10n_ve_invoice', 'l10n_ve', 'contacts', 'account','account_accountant', 'account_debit_note', 'sale', 'purchase','stock', 'product'],
    'data': [
